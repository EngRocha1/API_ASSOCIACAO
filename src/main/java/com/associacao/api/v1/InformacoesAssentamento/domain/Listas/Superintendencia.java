...
@Entity(name = "superintendencia")
@Getter
@Setter
@ToString
@RequiredArgsConstructor
@SQLRestriction(value = "ativo = true")
public class Superintendencia extends Listagem {

    public Superintendencia(String id, String name, boolean ativo) {
    ...
    public final boolean equals(Object o) {
        ...
        Superintendencia that = (Superintendencia) o;
