...
public class AtoMovimentacao extends Listagem {
    ...
    public AtoMovimentacao(String id, String name, NomeacaoExoneracao tipo, boolean ativo, Simbolo simbolo, Vinculo vinculo, Cargo cargo, LocalDate dataefeito, DiarioOficial diariooficial) {
    ...
    public final boolean equals(Object o) {
        ...
        AtoMovimentacao that = (AtoMovimentacao) o;
