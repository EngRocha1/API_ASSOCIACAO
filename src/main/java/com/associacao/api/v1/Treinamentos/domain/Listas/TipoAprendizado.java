...
@Table(name="TipoAprendizado")
@Entity(name="TipoAprendizado")
@Getter
@Setter
@ToString
@RequiredArgsConstructor
@SQLRestriction(value = "ativo = true")
public class TipoAprendizado extends Listagem {

    public TipoAprendizado(
            String id,
            String name,
            boolean ativo
    )
    ...
    public final boolean equals(Object o) {
        ...
        TipoAprendizado that = (TipoAprendizado) o;
